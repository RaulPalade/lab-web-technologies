...
export default {
  ...
  mounted() {
    this.totalRows = this.ActiveTimeSlots.length;
  },
  created: function() {
  ...
  computed: {
    ...mapGetters({
      ActiveTimeSlots: "StateActiveTimeSlots",
      DeactivatedTimeSlots: "StateDeactivatedTimeSlots",
    }),
    sortOptions() {
