...
start transaction;
insert into TeacherBooking values ('luca.roversi@unito.it', 'Lunedì', '15','Programmazione II');
insert into TeacherBooking values ('luca.roversi@unito.it', 'Lunedì', '16','Programmazione II');
insert into TeacherBooking values ('luca.roversi@unito.it', 'Lunedì', '16','Programmazione III');
commit;

start transaction;
insert into Subscription values ('raul.palade@edu.unito.it', 'luca.roversi@unito.it', 'Lunedì', 15);
insert into Subscription values ('giuseppe.moramarco@edu.unito.it', 'luca.roversi@unito.it', 'Lunedì', 16);
insert into Subscription values ('daniele.pepe@edu.unito.it', 'luca.roversi@unito.it', 'Lunedì', 14);
begin;